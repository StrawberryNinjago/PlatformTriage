...
public final class PlatformTriageTools {
    ...
    public static final String CHECK_VERSIONS = "check_versions";
    public static final String TRACE_SEARCH = "trace_search";
