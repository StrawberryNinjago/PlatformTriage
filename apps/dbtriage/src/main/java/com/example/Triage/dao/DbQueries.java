...
public class DbQueries {
  ...
  public static final String GET_LATEST_APPLIED = """
      SELECT installed_rank, version, description, script, installed_on, installed_by
  ...
  public static final String GET_FLYWAY_HISTORY_RECENT = """
      SELECT installed_rank, version, description, type, script, installed_by,
  ...
  public static final String GET_FLYWAY_INSTALLED_BY_SUMMARY = """
      SELECT installed_by, COUNT(*) AS applied_count, MAX(installed_on) AS last_seen
      FROM public.flyway_schema_history
